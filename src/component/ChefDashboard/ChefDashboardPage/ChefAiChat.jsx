...
// console.log("getChatMessageList",getChatMessageList)
...
//       const chatMessageId = response?.data?.id; // Assuming the backend returns the message ID
...
//           isUser: false,
//           timestamp: new Date(),
//           id: chatMessageId, // Store the message ID
//         },
//       ]);
//     } catch (error) {
...
//     try {
//       const formData = {
//         chat_message_id: String(message.id), // Ensure it's a string
//         react: type, // "like" or "dislike"
//       };
            ...
            <div className="flex space-x-6">
              ...
              <div className="relative" ref={dropdownRef}>
                ...
                {showDropdown && (
                  <div className="absolute top-full mt-2 w-40 bg-white border border-[#EFE9F8] rounded-lg shadow-lg z-10">
                    <Link
                      to='/chef_dashboard/inspiration_chat'
                      onClick={handleInspirationClick}
                      className="block w-full text-left px-4 py-2 text-[#5B21BD] hover:bg-gray-100"
                    >
                      New Creation

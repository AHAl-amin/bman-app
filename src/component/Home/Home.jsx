...
const Home = () => {
    ...
    }, [idOfItems, searchQuery, selectedSubTitle]);
                        ...
                        >
                            <div className="h-52 relative">
                                ...
                                <div className='absolute top-4 left-4'>
                                    <img className='w-10 bg-gray-300 rounded-full z-50' src={item.chef_image} alt="chef_image" />
                                </div>
                            </div>
                            <div className="p-6">
                                ...
                                <div className="flex justify-between">
                                    <div className="flex items-center px-2 py-1 rounded">
                                        ...
                                        <span className="text-[#676767] font-medium ml-1">{parseInt(item.rating, 10)}</span>
                                    </div>
                                    <button
                                        className="px-4 py-2 text-[#5B21BD] text-[18px] font-medium rounded cursor-pointer"
                                        onClick={() => openModalWithChef({
                                            id: item.brand_id,
